...
1. Install the gem for your testing framework: `bundle add selective-ruby-minitest`
...
4. Change the test command in your CI pipeline from `bundle exec rake test` (or `bundle exec ruby -Itest …`) to `bundle exec selective minitest`. Standard Minitest flags (`-n`, `-e`, `--seed`, `-v`, etc.) are forwarded to Minitest.

### Github Actions

[View a full/working example](https://github.com/selectiveci/selective-ruby-minitest/blob/main/.github/workflows/main.yml)
...
[View a full/working example](https://github.com/selectiveci/selective-ruby-minitest/blob/main/.circleci/config.yml)
...
[View a full/working example](https://github.com/selectiveci/selective-ruby-minitest/blob/main/.semaphore/semaphore.yml)
...
| SELECTIVE_PLATFORM      | Yes       | The CI Platform that the Selective client is running on. Example: semaphore, circleci, etc.                                  |
...
Bug reports and pull requests are welcome on GitHub at https://github.com/selectiveci/selective-ruby-minitest. This project is intended to be a safe, welcoming space for collaboration, and contributors are expected to adhere to the [code of conduct](https://github.com/selectiveci/selective-ruby-minitest/blob/main/CODE_OF_CONDUCT.md).
